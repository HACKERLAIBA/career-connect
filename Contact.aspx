<%@ Page Title="" Language="C#" MasterPageFile="~/USER/usermaster.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="CareerConnect.USER.Contact" %>
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>Wah Cantt, Pakistan.</h3>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                        <div class="media-body">
                            <h3>+92 318 0585010</h3>
                    ...
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>umairmuhammad3162@gmail.com</h3>
